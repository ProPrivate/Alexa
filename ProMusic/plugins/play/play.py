...
from ProMusic.utils.database import is_video_allowed
...
from ProMusic.utils.inline.play import (
    livestream_markup,
    playlist_markup,
    slider_markup,
    track_markup,
)
from ProMusic.utils.inline.playlist import botplaylist_markup
from ProMusic.utils.logger import play_logs
from ProMusic.utils.stream.stream import stream
from config import BANNED_USERS, lyrical
from strings import get_command
from ProMusic.utils.database import is_served_user
...
async def play_commnd(
    ...
    if not await is_served_user(message.from_user.id):
        await message.reply_text(
            text="😢 ᴅᴇᴀʀ ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴀ ᴠᴇʀɪғɪᴇᴅ ɪɴ ᴍʏ ᴅᴀᴛᴀʙᴀsᴇ.\n☔ ᴘʟᴇᴀsᴇ ᴜsᴇ /verify ᴛᴏ ᴠᴇʀɪғʏ ʏᴏᴜʀsᴇʟғ ɪɴ ᴍʏ ᴅᴀᴛᴀʙᴀsᴇ.",
        )
        return
